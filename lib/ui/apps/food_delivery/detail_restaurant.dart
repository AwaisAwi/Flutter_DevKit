...
import 'package:devkitflutter/ui/apps/food_delivery/cart.dart';
...
import 'package:devkitflutter/ui/apps/food_delivery/restaurant_information.dart';
        ...
        children: [
          Container(
            ...
            child: ListView(
              ...
              children: [
                buildCacheNetworkImage(width: bannerWidth, height: bannerHeight, url: GLOBAL_URL+"/assets/images/apps/food_delivery/food/4.jpg"),
                _buildMerchantTop(),
    ...
    return Column(
      ...
      children: [
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              GestureDetector(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => RestaurantInformationPage()));
                  },
        ...
        Container(
          ...
          child: Text('Steam Boat Lovers - Lefferts Avenue', style: GlobalStyle.restaurantTitle, maxLines: 2, overflow: TextOverflow.ellipsis),
        ),
        SizedBox(height: 4),
        Container(
          margin: EdgeInsets.symmetric(horizontal: 16),
